...
export declare type THTTPSecurityScheme = ({
    scheme?: "bearer";
} & {
    scheme: string;
    bearerFormat?: string;
...
export declare type THeader = TSchemaXorContent & {
    description?: string;
    required?: boolean;
    deprecated?: boolean;
...
export declare type TParameter = TParameterLocation & {
    name: string;
    in: string;
    description?: string;
    required?: boolean;
...
export declare type TParameterLocation = {
    in?: "path";
...
export declare type TSchemaXorContent = any;
export declare type TSecurityScheme = IAPIKeySecurityScheme | THTTPSecurityScheme | IOAuth2SecurityScheme | IOpenIDConnectSecurityScheme;
